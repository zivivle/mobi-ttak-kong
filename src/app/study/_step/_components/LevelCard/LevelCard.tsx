...
export const LevelCard = ({ level, className }: LevelCardProps) => {
  return (
    <ToggleItem
      value={level}
      className={`flex flex-col gap-[20px] p-[36px] items-center justify-center w-[224px] h-[320px] rounded-[20px] bg-primary-50 focus:bg-primary-100 focus:text-black hover:bg-primary-100 hover:text-black ${className}`}
    >
