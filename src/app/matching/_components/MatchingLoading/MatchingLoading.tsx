...
export const MatchingLoading = () => {
  return (
    <div className="bg-white flex flex-col justify-center items-center rounded-[40px]">
      ...
      <div>
        <Button className="mt-10 mb-20 w-[260px] h-[50px] rounded-[30px]">나만의 스터디 직접 만들러가기</Button>
      </div>
    </div>
  )
}
